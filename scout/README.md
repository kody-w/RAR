...
Generated: 1714 reversible Toasted skill(s), 218 bounded skill bundle(s), and 40 disabled workflow template(s). Canonical RAR agent bytes remain under `agents/`; `scout/` is removable compatibility output.
