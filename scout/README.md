...
Generated: 1816 reversible Toasted skill(s), 230 bounded skill bundle(s), and 39 disabled workflow template(s). Canonical RAR agent bytes remain under `agents/`; `scout/` is removable compatibility output.
