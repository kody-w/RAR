...
Full conformance is never self-certified. Evidence references must be
content-addressed or public HTTPS resources, bound to an independent verifier
from an explicit trust-anchor set, and appropriate to the requirement being
proven. Without trusted independent evidence, the result is a conformance
candidate rather than a Full claim.
