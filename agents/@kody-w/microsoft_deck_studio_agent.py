...
WORDMARK = "RAPP · Rapid Agent Prototyping Platform"
...
def render_title(s, d, i):
    ...
    txt(s, x + Inches(0.03), Inches(cur), Inches(11), Inches(0.5),
        [P([R(d.get("expand", "Rapid Agent Prototyping Platform"), 20, LIGHTBLUE, True, spacing=0.8)])])
    cur += 0.6
    if d.get("tag"):
...
def _build_deck(spec, out_path):
    ...
    WORDMARK = deck.get("wordmark", "RAPP · Rapid Agent Prototyping Platform")
